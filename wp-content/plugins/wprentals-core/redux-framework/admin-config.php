...
$args = array(
    ...
    'menu_title'           => __( 'Sbrvh Options', 'wprentals-core' ),
    'page_title'           => __( 'Sbrvh Options', 'wprentals-core' ),
...
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/general-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/booking-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/login-register-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/add-listing-page-payment-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/social-contact-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/header-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/footer-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/listing-page.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/listing-card-design.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/design-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/email-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/maps-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/advanced-search-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/blog-settings.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/advanced-options.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/sms-managemnt.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/wprentals-api.php';  
require_once WPESTATE_PLUGIN_PATH . 'redux-framework/theme-admin-sections/help-settings.php';  
