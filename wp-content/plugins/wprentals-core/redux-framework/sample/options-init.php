    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'subtitle' => __( '*Login from property page always redirects user to the same page. *Option does NOT apply to social login feature.', 'wprentals-core' ),
                'options'  => array(
                    'yes'   => 'yes',
                    'no'    => 'no'
                ),
            ...
            array(
                ...
                'title'    => __( 'The link where users are redirected after login', 'wprentals-core' ),
                'subtitle' => __( '*If blank, users are redirected to user profile page. *Login from property page always redirects user to the same page. *Option does NOT apply to social login feature.', 'wprentals-core' ),
            ),
            array(
