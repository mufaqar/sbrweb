...
?>
<div class="property-description-wrap property-section-wrap <?php if($is_show_more) {?>is-show-more<?php } ?>" id="property-description-wrap" role="region">
                        ...
                        <div class="d-flex justify-content-between" role="listitem">
							...
							<div class="property-document-link login-link">
								...
								<?php if( $documents_download == 1 ) {
				                    ...
				                    <a href="<?php echo esc_url( $attachment_meta->guid ); ?>" target="_blank"><?php esc_html_e( 'Download', 'houzez' ); ?> <i class="houzez-icon icon-download-bottom ms-2" aria-bs-hidden="true"></i></a>
				                    <?php } else { ?>
