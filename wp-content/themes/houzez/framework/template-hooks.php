...
add_action( 'wp_footer', 'houzez_backtotop_compare' );
add_action( 'wp_footer', 'houzez_login_password_reset' );
add_action( 'wp_footer', 'houzez_listing_preview' );
add_action( 'wp_footer', 'houzez_realtor_contact_form' );